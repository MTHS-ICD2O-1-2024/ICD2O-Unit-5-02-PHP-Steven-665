...
<head>
  <meta charset="utf-8" />
  <meta name="description" content="Positive or Negaive #, in PHP " />
  ...
  <title>Positive or Negaive #, in PHP </title>
</head>
    ...
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
      <header class="mdl-layout__header">
        <div class="mdl-layout__header-row">
          <span class="mdl-layout-title">Positive or Negaive #, in PHP</span>
        </div>
      </header>
